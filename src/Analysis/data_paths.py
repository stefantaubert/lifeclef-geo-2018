...
most_common_values_diagram = root + "analysis/most_common_values_diagram_" + str(settings.pixel_count) + ".pdf"
species_channel_map_dir = root + "analysis/channel_maps_" + str(settings.pixel_count) + "/"
